@echo off
:: Generated on 2025-09-15 03:03:35 GMT
...
:START_PROCESS
title 26100.6713_amd64_zh-cn_core_634239fb download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=634239fb-1e01-4e55-9718-c795871a1aa6&pack=neutral&edition=app&aria2=2"
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=634239fb-1e01-4e55-9718-c795871a1aa6&pack=zh-cn&edition=core&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
