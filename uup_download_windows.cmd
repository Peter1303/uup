@echo off
:: Generated on 2025-09-12 11:30:19 GMT
...
:START_PROCESS
title 26100.6584_amd64_zh-cn_core_b29c1075 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=b29c1075-223e-4d81-9cfe-100893f1ee62&pack=neutral&edition=app&aria2=2"
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=b29c1075-223e-4d81-9cfe-100893f1ee62&pack=zh-cn&edition=core&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
