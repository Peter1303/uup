@echo off
:: Generated on 2026-08-27 09:09:04 GMT
...
:START_PROCESS
title 26200.9267_amd64_zh-cn_core_fc2fbfd7 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=fc2fbfd7-10b4-480f-967e-9af61f9d48c3&pack=zh-cn&edition=core&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
