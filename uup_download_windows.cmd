@echo off
:: Generated on 2026-02-20 16:57:35 GMT
...
:START_PROCESS
title 19045.6937_amd64_zh-cn_multi_0e79c917 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=0e79c917-93de-48aa-b6ab-6ea61dc972d4&pack=zh-cn&edition=professional%%3Bcorecountryspecific%%3Bcore&aria2=2"
